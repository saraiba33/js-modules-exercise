...
p.textContent = _differenceJsDefault.default(arrayOne, arrayTwo);

},{"./utilities/difference.js":"1X3vc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1X3vc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
function notInBoth(arrayOne, arrayTwo) {
    const dif = _lodashDefault.default.difference(arrayOne, arrayTwo);
    console.log(`The difference between ${arrayOne} and ${arrayTwo} is ${dif}`);
}
